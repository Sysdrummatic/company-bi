  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        {/* Bouncing ball groups */}
        <div className="absolute top-10 left-5">
          <div className="relative">
            <div className="w-3 h-3 bg-business-primary/40 rounded-full animate-bounce-balls"></div>
            <div className="w-2 h-2 bg-business-accent/50 rounded-full absolute top-4 left-2 animate-bounce-balls delay-300"></div>
            <div className="w-2 h-2 bg-business-secondary/40 rounded-full absolute top-2 left-4 animate-bounce-balls delay-500"></div>
          </div>
        </div>
        <div className="absolute top-32 right-8">
          <div className="relative">
            <div className="w-3 h-3 bg-business-accent/40 rounded-full animate-bounce-balls delay-1000"></div>
            <div className="w-2 h-2 bg-business-primary/50 rounded-full absolute top-4 left-2 animate-bounce-balls delay-1300"></div>
            <div className="w-2 h-2 bg-business-secondary/40 rounded-full absolute top-2 left-4 animate-bounce-balls delay-1500"></div>
          </div>
        </div>
        <div className="absolute bottom-32 left-12">
          <div className="relative">
            <div className="w-3 h-3 bg-business-secondary/40 rounded-full animate-bounce-balls delay-2000"></div>
            <div className="w-2 h-2 bg-business-primary/50 rounded-full absolute top-4 left-2 animate-bounce-balls delay-2300"></div>
            <div className="w-2 h-2 bg-business-accent/40 rounded-full absolute top-2 left-4 animate-bounce-balls delay-2500"></div>
          </div>
        </div>
        <div className="absolute bottom-10 right-16">
          <div className="relative">
            <div className="w-3 h-3 bg-business-primary/40 rounded-full animate-bounce-balls delay-3000"></div>
            <div className="w-2 h-2 bg-business-secondary/50 rounded-full absolute top-4 left-2 animate-bounce-balls delay-3300"></div>
            <div className="w-2 h-2 bg-business-accent/40 rounded-full absolute top-2 left-4 animate-bounce-balls delay-3500"></div>
          </div>
        </div>
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="container mx-auto px-4 pt-16 pb-8">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-text-contrast mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
              Business Intelligence
            </h1>
            <p className="text-xl md:text-2xl text-text-contrast mb-8 max-w-3xl mx-auto leading-relaxed">
